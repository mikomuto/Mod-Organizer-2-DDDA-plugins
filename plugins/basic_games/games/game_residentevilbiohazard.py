...
class ResidentEvilBiohazardModDataChecker(mobase.ModDataChecker):
    ...
    def dataLooksValid(self, filetree: mobase.IFileTree) -> mobase.ModDataChecker.CheckReturn:
        VALID_ROOT_FOLDERS = [ "arc","arcPC","mnlts","movie","sa","shader","sound","system" ]
...
class ResidentEvilBiohazard(BasicGame):
    Name = "Resident Evil Biohazard HD Support Plugin"
    Author = "MikoMuto"
    Version = "1.0.0"

    GameName = "Resident Evil Biohazard HD"
    GameShortName = "residentevilbiohazardhdremaster"
    GameNexusName = "residentevilbiohazardhdremaster"
    GameSteamId = 304240
    GameBinary = "bhd.exe"
    ...
    def get_cloud_save_directory():
        ...
        for child in user_data.iterdir():
            ...
            if steam_ident == -1:
                continue
            cloud_saves = child.joinpath("304240", "remote")
